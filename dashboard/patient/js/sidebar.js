            ...
            if (!$(this).hasClass("active")) {
                ...
                if ($(this).hasClass("active")) {
                    ...
                    if (($(this).hasClass('agenda'))) {
                        $('.agenda.dashboard').addClass('active');
                    }
                    if (($(this).hasClass('imagediagnosis'))) {
                        $('.imagediagnosis.dashboard').addClass('active');
                    }
                    if (($(this).hasClass('brain-xonet'))) {
                        $('.brain-xonet.dashboard').addClass('active');
                    }
                    if (($(this).hasClass('blockchain'))) {
                        $('.blockchain.dashboard').addClass('active');
                    }
                    if (($(this).hasClass('derm-detect'))) {
                        $('.derm-detect.dashboard').addClass('active');
                    }
                }
